...
export default function WeatherWidget() {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-4 border-b-4 border-amber-400 transition hover:shadow-md">
      <div className="flex justify-between items-center mb-3">
        <h3 className="font-bold text-xs text-slate-800 dark:text-slate-200 uppercase tracking-wider flex items-center gap-1.5">
          <span>Campus Havası</span>
        </h3>
        <span className="text-[10px] font-medium text-slate-400 bg-slate-100 dark:bg-slate-700/60 px-1.5 py-0.5 rounded flex items-center gap-1">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="text-center p-2 rounded-xl bg-slate-50 dark:bg-slate-750 border border-slate-100 dark:border-slate-700/40">
